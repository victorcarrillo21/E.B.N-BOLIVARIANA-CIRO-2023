    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../../index.php">
                ...
                <div class="sidebar-brand-text mx-3">PROSECUCION</div>
            </a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="../Inscripcion/representante.php">Representante</a>
                        <a class="collapse-item " href="../Inscripcion/alumno.php">Alumno</a>
                        <a class="collapse-item active" href="../Inscripcion/salud_transporte.php">Salud y Transporte</a>
                        <a class="collapse-item active" href="../Inscripcion/procedencia.php">Procedencia</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../../Procesos/Horarios/horario.php">
